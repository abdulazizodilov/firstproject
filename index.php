...
// Foydalanuvchi tizimga kirganmi yoki yo'qligini tekshiramiz
// Agar kirgan bo'lsa uning rolini olamiz, aks holda 'guest' (mehmon) deb hisoblaymiz
                    ...
                    <div class="carousel-item active"> <svg aria-hidden="true" class="bd-placeholder-img " height="100%" preserveAspectRatio="xMidYMid slice" width="100%" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-start">
                                ...
                                <p><a class="btn btn-lg btn-primary" href="#">Batafsil o'qish...</a></p>
                            </div>
                        </div>
                    </div>
